    ...
    public function run(): void
    {
        ...
        DB::table('park_reservations')->insert([
            ...
            [
                ...
                'codigo_qr'                => Str::uuid(),
                'tax_id'                   => 1,
                'adult_price_total'        => 3 * 25.00,
                'child_price_total'        => 1 * 18.00,
                'applied_tax'              => 10.00,
                'created_at'               => now(),
                'updated_at'               => now(),
            ],
            [
                ...
                'codigo_qr'                => Str::uuid(),
                'tax_id'                   => 1,
                'adult_price_total'        => 1 * 15.00,
                'child_price_total'        => 2 * 10.00,
                'applied_tax'              => 10.00,
                'created_at'               => now(),
                'updated_at'               => now(),
            ],
            ...
            [
                ...
                'codigo_qr'                => Str::uuid(),
                'tax_id'                   => 1,
                'adult_price_total'        => 2 * 25.00,
                'child_price_total'        => 2 * 18.00,
                'applied_tax'              => 10.00,
                'created_at'               => now(),
                'updated_at'               => now(),
            ],
